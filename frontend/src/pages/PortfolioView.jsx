...
import { Briefcase, Code, Lightbulb, Mail, MapPin, Phone, Github, Linkedin, Award } from 'lucide-react';
    ...
    <div className="portfolio-container">
      ...
      <section className="section-container" id="experience">
        ...
        <div className="timeline">
          {portfolioData.experience.map((exp, index) => (
            <div key={exp.id} className={`timeline-item ${isVisible ? 'slide-up' : ''}`} style={{ animationDelay: `${index * 0.2}s` }}>
      ...
      <section className="section-container" id="projects">
        ...
        <div className="projects-grid">
          {portfolioData.projects.map((project, index) => (
            <div key={project.id} className={`project-card ${isVisible ? 'fade-in' : ''}`} style={{ animationDelay: `${index * 0.2}s` }}>
          ...
          <div className="skill-category">
            ...
            <div className="skill-tags">
              {portfolioData.skills.ai.map((skill, i) => (
                <span key={i} className="skill-tag skill-tag-highlight">{skill}</span>
              ))}
            </div>
          </div>
          <div className="skill-category">
      ...
      <section className="section-container" id="education">
        ...
        <div className="education-card">
          ...
          <div className="education-institution">{portfolioData.education.institution}</div>
          <div className="education-details">
            <span>{portfolioData.education.duration}</span>
            <span className="education-cgpa">CGPA: {portfolioData.education.cgpa}</span>
          </div>
        </div>
      </section>
      ...
      <section className="section-container" id="contact">
        ...
        <div className="contact-grid">
          ...
          <a href={`tel:${portfolioData.personal.phone}`} className="contact-item">
            <Phone size={24} />
          ...
          <a href={portfolioData.personal.github} className="contact-item" target="_blank" rel="noopener noreferrer">
            <Github size={24} />
            <span>GitHub</span>
          </a>
          <a href={portfolioData.personal.linkedin} className="contact-item" target="_blank" rel="noopener noreferrer">
            <Linkedin size={24} />
            <span>LinkedIn</span>
          </a>
        </div>
